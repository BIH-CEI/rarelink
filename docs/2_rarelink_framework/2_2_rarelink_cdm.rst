...
- When running ``rarelink redcap export-records`` you will see, that the data 
  ...
  to :ref:`4_3`. 
- Within the data model itself, we use its `python classes and properties <https://github.com/BIH-CEI/rarelink/tree/develop/src/rarelink_cdm/python_datamodel>`_ 
