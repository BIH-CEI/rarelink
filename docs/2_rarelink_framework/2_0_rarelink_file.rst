...
overview of the different components of the RareLink framework, including the
native REDCap sheets, the entire project set up, the supported ontologies, the 
