...
RareLink is licensed under open-source an Apache License 2.0. The following:
...
1. Definitions.
   ...
   original version of the Work and any modifications or additions to the
...
4. Redistribution.  
   ...
   (d) If the Work includes a "NOTICE" text file as part of its
       ...
       within the Source form, or within a display generated by the
   ...
   (e) You may add Your own attribution notices within Derivative Works
       ...
       file, provided that such additional attribution notices cannot be
