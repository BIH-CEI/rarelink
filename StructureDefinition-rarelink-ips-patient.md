...
| Draft as of 2026-08-01 | *Computable Name*:RareLinkIPSPatient |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/rarelink-ig|current/StructureDefinition/StructureDefinition-rarelink-ips-patient.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/birth-place"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/date-of-admission"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/recorded-sex-at-birth"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/cause-of-death"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/vital-status"]
      }],
      "mustSupport" : true
    },
    {
