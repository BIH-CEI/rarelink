...
* meta.profile = "http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-laboratory-pathology-uv-ips|2.0.0-ballot" (exactly)
* status 1..1
...
<div xmlns="http://www.w3.org/1999/xhtml">
  <p><strong>RareLink IPS Measurement Laboratory</strong></p>
  <p>This profile is based on the RareLink-CDM Section (6.3) Measurements and the IPS Observation profile, specifically for laboratory measurements.</p>
</div>
"""
