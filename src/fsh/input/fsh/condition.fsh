...
* clinicalStatus.coding.system from http://terminology.hl7.org/CodeSystem/condition-clinical
* verificationStatus 1..1
* verificationStatus.coding 1..1
* verificationStatus.coding.system from http://terminology.hl7.org/CodeSystem/condition-ver-status
* severity 0..1
* severity.coding 0..1
* severity.coding.system from http://snomed.info/sct (preferred)
* text.div = """
