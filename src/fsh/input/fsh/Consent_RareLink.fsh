...
* scope 1..1
* scope.coding.system = "http://terminology.hl7.org/CodeSystem/consentscope" (required)
* scope.coding.code = #research

* category 1..1
* category.coding.system = "http://terminology.hl7.org/CodeSystem/consentcategorycodes" (required)
