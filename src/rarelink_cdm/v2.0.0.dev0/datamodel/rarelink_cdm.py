...
# Generation date: 2024-12-14T23:58:35
# Schema: rarelink_cdm
#
...
class Record(YAMLRoot):
    ...
    formal_criteria: Optional[Union[str, FormalCriteriaSnomed422549004]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.formal_criteria is not None and not isinstance(self.formal_criteria, FormalCriteriaSnomed422549004):
            self.formal_criteria = FormalCriteriaSnomed422549004(self.formal_criteria)
...
slots.formal_criteria = Slot(uri=RARELINK_CDM.formal_criteria, name="formal_criteria", curie=RARELINK_CDM.curie('formal_criteria'),
                   model_uri=RARELINK_CDM.formal_criteria, domain=None, range=Optional[Union[str, FormalCriteriaSnomed422549004]])
...
slots.codeSystemsContainer__hpo = Slot(uri=RARELINK.hpo, name="codeSystemsContainer__hpo", curie=RARELINK.curie('hpo'),
                   model_uri=RARELINK_CDM.codeSystemsContainer__hpo, domain=None, range=Union[str, "HPO"])
