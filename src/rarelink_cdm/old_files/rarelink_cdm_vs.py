...
#               ],
#               name="Value set for 6.2.2 Status",
...
#        vs_6_2_3 = ValueSet(
#               elements=[Date],
#               name="Value set for 6.2.3 Determination Date",
...
#        vs_6_2_4 = ValueSet(
#               elements=[Date],
#               name="Value set for 6.2.4 Resolution Date",
...
#               description=("Time at which the feature was first observed within HPO" 
#                      "onset categories.")   
#        )
#        vs_6_2_6 = ValueSet(
#               elements=[
...
#        vs_6_2_8a = ValueSet(
#               elements=[res.HPO],
#               name="Value set for 6.2.8a - HPO Modifier",
...
#        vs_6_2_8b = ValueSet(
#               elements=[res.HPO],
#               name="Value set for 6.2.8b - HPO Modifier",
#               description=("Further clinical modifiers to describe a specific "
#                             "phenotypic feature, if possible part of HP:0012823")                     
#        )
#        vs_6_2_8c = ValueSet(
#               elements=[res.HPO],
#               name="Value set for 6.2.8c - HPO Modifier",
#               description=("Further clinical modifiers to describe a specific "
#                             "phenotypic feature, if possible part of HP:0012823")
#        )
#        vs_6_2_8d = ValueSet(
#               elements=[res.NCBITaxon],
#               name="Value set for 6.2.8d - Causing Agent ",
#               description=("If applicable, the causing organism of the phenotypic"
#                             " feature encoded with HPO.")
#        )
#        vs_6_2_8e = ValueSet(
#               elements=[res.SNOMED_CT],
#               name="Value set for 6.2.8e SNOMED Modifier (Body Site)",
#               description=("If applicable, the primary body site of the phenotypic"
#                             " feature encoded with SNOMED.")
#        )
       
#        vs_6_2_9 = ValueSet(
#               elements=[res.ECO],
#               name="Value set for 6.2.9 Evidence",
#               description=("The evidence supporting the phenotypic feature.")
#        )
...
#        vs_6_3_1 = ValueSet(
#               elements=[res.LOINC],
#               name="Value set for 6.3.1 Assay",
#               description=(" class that describes the assay used to producethe\
#                      measurement.")
#        )
#        vs_6_3_2 = ValueSet(
#               elements=[float],
#               name="Value set for 6.3.2 Measurement Value",
#               description=("The value of the measurement."),
#        )
#        vs_6_3_3 = ValueSet(
#               elements=[res.UO],
#               name="Value set for 6.3.3 Measurement Unit",
#               description=("The unit of the result's measurement")
#        )
#        vs_6_3_4 = ValueSet(
#               elements=[res.NCIT],
#               name="Value set for 6.3.4 Measurement Interpretation",
#               description=("he interpretation of the measurement (e.g.:\
#                      Below/Within/Above age-related reference range,\
#                             Absent/Low/Normal, or Positive/Negative)")      
#        )
#        vs_6_3_5 = ValueSet(
#               elements=[Date],
#               name="Value set for 6.3.5 Measurement Time Observed",
#               description=("Time at which the measurement was performed.")
#        )
#        vs_6_3_6 = ValueSet(
#               elements=[res.SNOMED_CT, res.NCIT, res.LOINC],
#               name="Value set for 6.3.6 Measurement Procedure",
...
#        vs_6_4_1 = ValueSet(
#               elements=[str],
#               name="Value set for 6.4.0 Pseudonym",
...
#                      display="Not recorded")
#               ],
#               name="Value set for 6.4.2 Propositus/-a",
...
#        # 6.4.3 Relationship of the individual to the index case / 
#        # propositus/a
#        vs_6_4_3 = ValueSet(
#               elements=[
...
#                      display="Not recorded")
#               ],
#               name="Value set for 6.4.3 Relationship of the individual to the "
...
#                      display="Not recorded")
#               ],
#               name="Value set for 6.4.4 Consanguinity",
...
#                      display="Not recorded")
#               ],
#               name="Value set for 6.4.5 Family Member Relationship",
...
#               ],
#               name="Value set for 6.4.6 Family Member Record Status",
...
#                      display="Not recorded")
#               ],
#               name="Value set for 6.4.7 Family Member Sex",
...
#        vs_6_4_8 = ValueSet(
#               elements=[int],
#               name="Value set for 6.4.8 Family Member Age",
...
#        vs_6_4_9 = ValueSet(
#               elements=[Date],
#               name="Value set for 6.4.9 Family Member Date of Birth",
...
#                      display="Unknown")
#               ],
#               name="Value set for 6.4.10 Family Member Deceased",
#               description=("Indicates whether the selected family member is\
#                      deceased.")
#        )

#        # 6.4.11 Family Member Cause of Death [ICD10CM]
#        vs_6_4_11 = ValueSet(
#               elements=[res.ICD10CM],
#               name="Value set for 6.4.11 Family Member Cause of Death [ICD10CM]",
...
#        vs_6_4_12 = ValueSet(
#               elements=[int],
#               name="Value set for 6.4.12 Family Member Deceased Age",
#               description=("Records the age in full years of the selected family\
#                             member at death.")
#        )

#        # 6.4.13 Family Member Disease [MONDO]
#        vs_6_4_13 = ValueSet(
#               elements=[res.MONDO],
#               name="Value set for 6.4.13 Family Member Disease [MONDO]",
#               description=("Indicates whether the selected family member is\
#                             affected by the same RD as the individual or a\
