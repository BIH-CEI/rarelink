...
from rarelink.cli.utils.string_utils import format_header, success_text, error_text, format_command, hint_text
...
def download_records(output_dir: Path = DEFAULT_OUTPUT_DIR):
    """
    Fetch records from the configured REDCap project and save them locally as a JSON file.

    Args:
        output_dir (Path): Directory to save the fetched records. Defaults to ~/Downloads/rarelink_records.
    """
