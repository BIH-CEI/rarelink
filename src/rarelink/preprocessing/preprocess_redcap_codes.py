...
def parse_redcap_code(redcap_code: str, resources: List[CodeSystem]) -> Coding:
    """
    This method parses a string representation of a code in the REDCap format 
    to a Coding object.
    ...
    :param redcap_code: A string with format like 'snomed_1234567', 
                        ...
                        1. 'loinc_81304_8' should convert the underscore in 
                           the code part to a hyphen.
                        ...
                        3. For 'ICD10CM', 'ICD11', 'ICD10', and 'ICD9' codes, 
                           ...
                           with periods, and the prefix must be uppercased.
