...
| Draft as of 2026-08-01 | *Computable Name*:RareLinkPhenotypicFeature |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/rarelink-ig|current/StructureDefinition/StructureDefinition-rarelink-phenotypic-feature.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/phenotype-status"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/resolution-date"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/temporal-pattern"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/phenotype-severity"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/clinical-modifier-1"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/clinical-modifier-2"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/clinical-modifier-3"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/causing-agent"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/rarelink-ips-patient"]
      }]
    },
    {
