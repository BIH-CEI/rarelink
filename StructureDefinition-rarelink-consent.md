...
| Draft as of 2026-08-01 | *Computable Name*:RareLinkConsent |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/rarelink-ig|current/StructureDefinition/StructureDefinition-rarelink-consent.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/erdri-consent-to-reuse-data"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/erdri-agreement-to-be-contacted"]
      }]
    },
    {
