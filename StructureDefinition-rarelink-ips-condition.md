...
| Draft as of 2026-08-01 | *Computable Name*:RareLinkIPSCondition |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/rarelink-ig|current/StructureDefinition/StructureDefinition-rarelink-ips-condition.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/age-at-diagnosis"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://rarelink.bih-charite.de/fhir/StructureDefinition/age-at-onset"]
      }]
    },
    {
