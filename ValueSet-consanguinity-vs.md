# Consanguinity Value Set - RareLink Implementation Guide v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Consanguinity Value Set**

## ValueSet: Consanguinity Value Set 

| | |
| :--- | :--- |
| *Official URL*:https://rarelink.bih-charite.de/fhir/ValueSet/consanguinity-vs | *Version*:2.0.0 |
| Draft as of 2025-12-15 | *Computable Name*:ConsanguinityVS |
...
```json
{
  ...
  "id" : "consanguinity-vs",
  "url" : "https://rarelink.bih-charite.de/fhir/ValueSet/consanguinity-vs",
  "version" : "2.0.0",
  "name" : "ConsanguinityVS",
