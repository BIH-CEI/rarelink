# Home - RareLink Implementation Guide v2.0.0
...
| Draft as of 2026-08-01 | *Computable Name*:RareLinkImplementationGuide |
...
1. **The RareLink-CDM**: its corresponding REDCap data dictionary can be imported into any REDCap project with each instrument displaying a section within the RD-CDM for manual data entry of[LinkML-based](https://linkml.io/)semi-automatic data capture. The profiles in this implementation guide represent the entire RareLink-CDM with all elements of the RD-CDM mapped to FHIR elements and can also be used for import via the[Clinical Data Interoperability Services](https://www.sciencedirect.com/science/article/pii/S1532046421002008).
1. **A command-line interface (CLI)**(`rarelink`) interacting with the API of a local REDCap for:
...
![](rarelink_cdm_fhir_phenopackets.png)
...
```json
{
  ...
  "id" : "rarelink-ig",
  "url" : "https://rarelink.bih-charite.de/fhir/ImplementationGuide/rarelink-ig",
  "version" : "2.0.0",
  ...
  "description" : "An Implementation Guide for RareLink Common Data Model, based on the ontology-based rare disease common data model (RD-CDM) harmonising the European Rare Disease Infrastructure Common Data Set, HL7 FHIR R4, and Phenopackets; and integrating the IPS 2.0.0 profiles and Genomics Reporting 3.0.0 profiles.\n",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://rarelink.bih-charite.de/fhir/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-age-at-diagnosis.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-age-at-diagnosis-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-age-at-onset.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-age-category-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-age-of-onset-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-erdri-agreement-to-be-contacted.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/erdri-agreement-to-be-contacted"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-agreement-to-be-contacted-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/agreement-to-be-contacted-vs"
      },
      "name" : "Agreement to Be Contacted Value Set (ERDRI-CDS)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-birth-place.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-cause-of-death.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-cause-of-death-code.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/cause-of-death-code"
      },
      "name" : "Cause of Death Code",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-cause-of-death-definition.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/cause-of-death-definition"
      },
      "name" : "Cause of Death Definition",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-clinical-modifier-1.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/clinical-modifier-1"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-clinical-modifier-2.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/clinical-modifier-2"
      },
      "name" : "Clinical Modifier",
      "description" : "Modifier describing a specific phenotypic feature further (derived from clinical modifiers - HP:0012823)",
      "exampleBoolean" : false
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-clinical-modifier-3.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/clinical-modifier-3"
      },
      "name" : "Clinical Modifier",
      "description" : "Modifier describing a specific phenotypic feature further (derived from clinical modifiers - HP:0012823)",
      "exampleBoolean" : false
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-clinical-significance-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-consanguinity.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-consanguinity-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-erdri-consent-to-reuse-data.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/erdri-consent-to-reuse-data"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-consent-to-reuse-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/consent-to-reuse-vs"
      },
      "name" : "Consent to Reuse Data Value Set (ERDRI-CDS)",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-date-of-admission.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-dna-change-type-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-encounter-class-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-family-sex-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-family-relationship-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-genomic-source-class-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-karyotypic-sex-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-level-of-evidence-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-causing-agent.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/causing-agent"
      },
      "name" : "Phenotype Causing Organism",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-phenotype-severity.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/phenotype-severity"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-phenotype-severity-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/phenotype-severity-vs"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-phenotype-status.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-phenotype-status-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-temporal-pattern.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/temporal-pattern"
      },
      "name" : "Phenotype Temporal Pattern",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-propositus.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-propositus-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-condition-undiagnosed-rd-case.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-consent.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-diagnostic-implication.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-encounter.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-familyhistory.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-genetic-variant.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-ips-condition.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-ips-measurement-laboratory.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-ips-measurement-radiology.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-ips-patient.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-ips-procedure.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-observation-age-category.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-observation-gestation-at-birth.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-karyotypic-sex.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-observation-measurements-others.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-phenotypic-feature.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-rarelink-observation-vital-signs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-recorded-sex-at-birth.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-reference-genome-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-resolution-date.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-severity-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-structural-variant-method-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-temporal-pattern-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-undiagnosed-rd-case-vs.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-vital-status.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/vital-status"
      },
      "name" : "Vital Status",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-zygosity-vs.html"
      }],
      "reference" : {
